...
const meta = {
  title: "Components/JBLoading/Style",
  component: JBLoading,
...
function LoadingStyleSample({ className }: { className: string }) {
  return (
    <div style={{
      display: "flex",
      alignItems: "center",
      ...
      <JBLoading className={className} />
      <JBLoading className={`${className} small-loading`} />
      <JBLoading className={`${className} large-loading`} />
    </div>
  );
}
    ...
    <div style={{
      ...
      {styleSamples.map((sample) => (
        ...
        >
          ...
          <LoadingStyleSample className={sample.className} />
        </section>
      ))}
    </div>
  ),
...
export const Aurora: Story = {
  name: "Aurora",
  render: () => <LoadingStyleSample className="aurora-style aurora-style" />,
};

export const Forest: Story = {
  name: "Forest",
  render: () => <LoadingStyleSample className="forest-style forest-style" />,
};

export const Sunset: Story = {
  name: "Sunset",
  render: () => <LoadingStyleSample className="sunset-style sunset-style" />,
};

export const Porcelain: Story = {
  name: "Porcelain",
  render: () => <LoadingStyleSample className="porcelain-style porcelain-style" />,
};

export const Candy: Story = {
  name: "Candy",
  render: () => <LoadingStyleSample className="candy-style candy-style" />,
};

export const Terminal: Story = {
  name: "Terminal",
  render: () => <LoadingStyleSample className="terminal-style terminal-style" />,
};

export const Material: Story = {
  name: "Material",
  render: () => <LoadingStyleSample className="material-style material-style" />,
};

export const Fluent: Story = {
  name: "Fluent",
  render: () => <LoadingStyleSample className="fluent-style fluent-style" />,
};

export const Bootstrap: Story = {
  name: "Bootstrap",
  render: () => <LoadingStyleSample className="bootstrap-style bootstrap-style" />,
};

export const Cupertino: Story = {
  name: "Cupertino",
  render: () => <LoadingStyleSample className="cupertino-style cupertino-style" />,
};

export const AntDesign: Story = {
  name: "Ant Design",
  render: () => <LoadingStyleSample className="ant-design-style" />,
};
